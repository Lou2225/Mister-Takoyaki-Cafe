...
" x-effect="if (step === 2) startExpireTimer()">
    ...
    <div x-cloak x-show="step === 1" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">FORGOT PASSWORD</h1>
            <p class="text-[14px] text-slate-500 font-medium">Enter your registered email and we'll send a 6-digit code.</p>
        </div>
    ...
    <div x-show="step === 2" x-cloak
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">CHECK YOUR INBOX</h1>
            <p class="text-[14px] text-slate-500 font-medium mb-1">
            ...
            <div class="flex gap-3 justify-center" @paste.window="handlePaste">
                <template x-for="(d, i) in digits" :key="i">
                    <input
                        ...
                        class="w-12 h-16 text-center text-[24px] font-extrabold text-indigo-900 bg-slate-50 border border-slate-200 rounded-2xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition shadow-sm tracking-widest"
                    />
                </template>
            </div>
    ...
    <div x-show="step === 3" x-cloak
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">SET NEW PASSWORD</h1>
