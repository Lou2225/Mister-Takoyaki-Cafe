<div wire:poll.15s>
    ...
    <aside
        id="main-sidebar"
        :class="[
            isMobile ? 'fixed inset-y-0 left-0 z-50 transform w-[260px]' : 'relative z-30 flex-shrink-0',
            isMobile ? (sidebarOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full') : (sidebarOpen ? 'w-[260px]' : 'w-16')
        ]"
    ...
    >
        ...
        {{-- ── Navigation ── --}}
        <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 pb-4 pt-4 text-[13px] font-medium text-gray-600">
                ...
                @if($user->isSuperAdmin() || $user->isAdmin())
                    <div class="mb-4">
                        ...
                        <a href="{{ route('reports.index') }}"
                            ...
                            <span class="transition-opacity duration-300 whitespace-nowrap"
                                :class="sidebarOpen ? 'opacity-100' : 'opacity-0 hidden'">Business Intelligence</span>
                        </a>
