...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:super_admin|admin|cashier')->group(function () {
        ...
        // Print Bridge download (used by Settings → Thermal Printer → Wired)
        Route::get('/downloads/print-bridge', [\App\Http\Controllers\PrintBridgeController::class, 'download'])
            ->name('downloads.print-bridge');

        // Reports — Super Admin & Admin only
